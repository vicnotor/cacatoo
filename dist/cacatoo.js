...
class Gridmodel {
  ...
  setupColours(statecols, num_colours = 18) {
    ...
    for (const [statekey, statedict] of Object.entries(colours)) {
      if (statedict == 'default') {
        ...
        let colours = this.colourGradientArray(num_colours, 0, [0, 0, 0], [59, 82, 139], [33, 144, 140], [93, 201, 99], [253, 231, 37]);
        ...
        let colours = this.colourGradientArray(num_colours, 0, [246, 215, 70], [229, 92, 45], [132, 32, 107], [0, 0, 0]);
        return_dict[statekey] = colours;
      }
  ...
  */
  colourViridis(property, n, rev = false, option = "viridis") {
    ...
    if (option == "viridis") {
      if (!rev) this.colourGradient(property, n, [0, 0, 0], [59, 82, 139], [33, 144, 140], [93, 201, 99], [253, 231, 37]);         // Viridis
      else this.colourGradient(property, n, [253, 231, 37], [93, 201, 99], [33, 144, 140], [59, 82, 139], [0, 0, 0]);             // Viridis
    }
    else if (option == "inferno") {
      if (!rev) this.colourGradient(property, n, [0, 0, 0], [132, 32, 107], [229, 92, 45], [246, 215, 70]);         // Inferno
      else this.colourGradient(property, n, [246, 215, 70], [229, 92, 45], [132, 32, 107], [0, 0, 0]);              // Inferno
    }
  }
