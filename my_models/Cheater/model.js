...
var A2B = 0.5                    // Mutualist species A giving help to reproduce B
var B2A = 0.5                    // Mutualist species B giving help to reproduce A
var B2C = 0.4                    // Mutualist species B giving help to reproduce C ("cheater")
...
function cacatoo() {
  ...
  */
  ...
  sim.createDisplay("cheater", "species", "(zoom in on top-left)", 30, 30, 10)                     // Display the 'species' property of a small bit of the grid (i.e. zoom in)
  sim.spaceTimePlot("cheater", "Mutualists and cheater", "Space-time plot", 10, 200)              // Make a space-time plot based on the canvas "mutualists and cheater" called "Space-time plot". Draw row 10. Width 400. 
  ...
  */
  sim.cheater.updateGraphs = function() {
    ...
    let sumB = 0
    let sumC = 0
    for (let i = 0; i < this.ncol; i++)          // i are columns
      for (let j = 0; j < this.nrow; j++)      // j are rows
      {
